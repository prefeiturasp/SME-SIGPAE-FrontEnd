...
export { TIPO_SOLICITACAO } from "src/constants/shared";
...
export const URL_INCLUSAO_PAINEL = `${API_URL}/inclusao-alimentacao`;
...
export const URL_KIT_LANCHES_SOLICITACOES_PAINEL = `${API_URL}/solicitacao-kit-lanche`;
