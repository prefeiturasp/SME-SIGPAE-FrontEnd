export const mockGetVinculosTipoAlimentacaoPorEscolaCEMEI = {
  count: 6,
  next: null,
  previous: null,
  results: [
    ...
    {
      uuid: "3a1efae0-900b-42ed-acf8-8d003ea3cef4",
      tipo_unidade_escolar: {
        iniciais: "CEI DIRET",
        ativo: true,
        uuid: "8e0b5c4a-7293-47db-8488-89adf9dea892",
    ...
    {
      uuid: "78a2158e-23dd-4ce6-b2ff-571dfc7c409b",
      tipo_unidade_escolar: {
        iniciais: "CEI DIRET",
        ativo: true,
        uuid: "8e0b5c4a-7293-47db-8488-89adf9dea892",
    ...
    {
      uuid: "bbfead1a-f62f-42b6-9437-1ebb21ec32b0",
      tipo_unidade_escolar: {
        iniciais: "EMEI",
        ativo: true,
    ...
    {
      uuid: "71d6426b-6ffd-4655-b242-fa7db29aa7f8",
      tipo_unidade_escolar: {
        iniciais: "EMEI",
        ativo: true,
        uuid: "3f1aee3f-51f4-4759-aa2c-9ccf5c013c1c",
    ...
    {
      uuid: "6381730c-c565-4dcc-b8c9-83c5df4aa70c",
      tipo_unidade_escolar: {
        iniciais: "EMEI",
        ativo: true,
        uuid: "3f1aee3f-51f4-4759-aa2c-9ccf5c013c1c",
