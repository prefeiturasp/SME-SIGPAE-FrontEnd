...
export const mockRelatorioFinanceiroCEMEI = {
  ...
  lote: "149bf586-11ce-4e5e-869a-ef96ec6718e9",
  grupo_unidade_escolar: {
    tipos_unidades: [
      {
  ...
  legenda: "Fonte: Relatório de Medição Inicial",
  tabelas: [
    {
      nome: "Preço das Alimentações",
      periodo_escolar: "INTEGRAL",
    ...
    {
      nome: "Preço das Alimentações - Turma Infantil - EMEI",
      periodo_escolar: null,
      valores: [
        {
          faixa_etaria: null,
    ...
    {
      nome: "Dietas Tipo A e Tipo A Enteral - Turma Infantil - EMEI",
      periodo_escolar: null,
      valores: [
        {
          faixa_etaria: null,
    ...
    {
      nome: "Dietas Tipo B - Turma Infantil - EMEI",
      periodo_escolar: null,
      valores: [
        {
          faixa_etaria: null,
