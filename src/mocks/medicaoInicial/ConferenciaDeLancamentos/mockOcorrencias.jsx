export const mockOcorrenciaAprovadaPelaDRE = {
  logs: [
    {
      anexos: [
        {
...
export const mockOcorrenciaAprovadaPelaCODAE = {
  logs: [
    {
      anexos: [
        {
    ...
    },
    {
      ...
      criado_em: "04/02/2026 12:59:59",
      descricao:
        "Ocorrência f45eee81-e0d8-40f4-8054-f51f081d7d4c da Solicitação de Medição Inicial e6bf27e7-6bc5-46f9-a3f1-b713fec1ef69",
      justificativa: "<p>Ajustes os arquivos</p>",
      resposta_sim_nao: false,
      tipo_solicitacao_explicacao: "Solicitação de medição inicial",
    },
    {
      anexos: [
        {
          nome: "Protocolo RHUAN ANGELLO FERREIRA ABREU.pdf",
          arquivo: "/media/1f68300d-0e9b-4e6f-884b-f630e284f492.pdf",
          arquivo_url:
            "http://localhost:8000/media/1f68300d-0e9b-4e6f-884b-f630e284f492.pdf",
        },
        {
          nome: "arquivo_adesao.xlsx",
          arquivo: "/media/b952945d-b91e-4fde-883e-ebb13321e76d.xlsx",
          arquivo_url:
            "http://localhost:8000/media/b952945d-b91e-4fde-883e-ebb13321e76d.xlsx",
        },
      ],
      status_evento_explicacao: "Corrigido para CODAE",
      usuario: {
        uuid: "36750ded-5790-433e-b765-0507303828df",
        cpf: null,
        nome: "ESCOLA EMEF ADMIN",
      ...
      criado_em: "04/02/2026 13:06:27",
      descricao:
        "Ocorrência f45eee81-e0d8-40f4-8054-f51f081d7d4c da Solicitação de Medição Inicial e6bf27e7-6bc5-46f9-a3f1-b713fec1ef69",
      justificativa: "<p>ok</p>",
      resposta_sim_nao: false,
      tipo_solicitacao_explicacao: "Solicitação de medição inicial",
    },
    {
...
export const mockOcorrenciaDevolvidoParaAjustesPelaCODAE = {
  logs: [
    {
      anexos: [
        {
    ...
    },
    {
      ...
      criado_em: "06/02/2026 09:44:38",
      descricao:
        "Ocorrência cf9da872-77ee-4125-b8e4-2c2aed96dd84 da Solicitação de Medição Inicial aad6565e-0a08-482b-8a74-2aeba0c03110",
      justificativa: "<p>Ajuste o formulário</p>",
      resposta_sim_nao: false,
      tipo_solicitacao_explicacao: "Solicitação de medição inicial",
    },
  ],
