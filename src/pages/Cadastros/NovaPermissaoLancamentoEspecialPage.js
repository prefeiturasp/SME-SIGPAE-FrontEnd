...
import { NovaPermissaoLancamentoEspecial } from "src/components/screens/Cadastros/NovaPermissaoLancamentoEspecial";
import {
  CADASTROS,
  CONFIGURACOES,
...
export default () => {
  ...
  return _jsxs(Page, {
    ...
    botaoVoltar: true,
    children: [
      _jsx(Breadcrumb, { home: "/", anteriores: anteriores, atual: atual }),
      _jsx(NovaPermissaoLancamentoEspecial, {}),
    ],
  });
};
