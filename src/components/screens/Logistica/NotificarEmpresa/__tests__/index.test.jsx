...
// Testes para a página de Notificar Empresa
describe("Página: Notificar Empresa", () => {
  describe("Cenários de Sucesso", () => {
    it("deve carregar a página de notificação da empresa", async () => {
      await setupNotificarEmpresaPage();

      await waitFor(() => {
        const notificarEmpresaElements =
          screen.getAllByText("Notificar Empresa");
...
// Testes para a página de Detalhar Notificação
describe("Página: Detalhar Notificação", () => {
...
// Testes para a página de Analisar e Assinar
describe("Página: Analisar e Assinar", () => {
  describe("Cenários de Sucesso", () => {
    it("deve carregar a página de análise e assinatura", async () => {
      await setupAnalisarAssinarPage();

      await waitFor(() => {
        const analisarAssinarElements =
          screen.getAllByText("Analisar e Assinar");
...
// Testes de Comportamentos Compartilhados
describe("Comportamentos Compartilhados", () => {
...
// Testes de Agrupamento de Ocorrências
...
// Testes de Interação com Modais
...
// Testes de Controle de Aprovações
