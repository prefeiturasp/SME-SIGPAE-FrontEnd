...
jest.mock(
  "src/components/screens/Logistica/ConsultaSolicitacaoAlteracao/components/Filtros",
  () =>
    ({ setFiltros, setSolicitacoes, inicioResultado }) => (
      <div>
...
jest.mock(
  "src/components/screens/Logistica/ConsultaSolicitacaoAlteracao/components/ListagemSolicitacoes",
  () =>
    ({ solicitacoes }) => (
      <div>
...
function renderComponent() {
  return render(<ConsultaSolicitacaoAlteracao />);
}
...
describe("ConsultaSolicitacaoAlteracao", () => {
  beforeEach(() => {
    jest.clearAllMocks();
