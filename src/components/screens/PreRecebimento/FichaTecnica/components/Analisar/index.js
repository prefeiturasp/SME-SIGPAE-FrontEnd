...
export default ({ somenteLeitura = false }) => {
  ...
  const montarPayloadAnalise = (values) => {
    const payload = {
  ...
  const validaForm = (ehNaoPerecivel) => {
  ...
  const renderizarTag = () => {
    const tagMap = {
      ...
      "Enviada para Correção": _jsxs("div", {
  ...
  return _jsx(Spin, {
    ...
    spinning: carregando,
    children: _jsx("div", {
      className: "card mt-3 card-analise-ficha-tecnica",
      children: _jsx("div", {
        className: "card-body analise-ficha-tecnica",
        children: _jsx(Form, {
          onSubmit: () => {},
              ...
              children: [
                ...
                _jsx(ModalGenerico, {
                  ...
                  titulo: _jsx(_Fragment, {
                    children: "Cancelar An\u00E1lise da Ficha T\u00E9cnica",
                  }),
                  texto: _jsx(_Fragment, {
                    children:
                      "Deseja cancelar a An\u00E1lise da Ficha T\u00E9cnica?",
                  }),
                }),
              ],
            });
