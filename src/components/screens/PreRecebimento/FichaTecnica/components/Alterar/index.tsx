        ...
        <div className="card-body alterar-ficha-tecnica">
          ...
          >
            {({ handleSubmit, values, errors }: any) => {
              ...
              const ehPerecivel = ficha.categoria === "PERECIVEIS";
              const ehNaoPerecivel = ficha.categoria === "NAO_PERECIVEIS";
              const ehFLV =
                ficha.categoria === "FLV" &&
              ...
              return (
                <form onSubmit={handleSubmit}>
                      ...
                      {!ehFLV && (
                        <>
                          ...
                          <section id="armazenamento">
                            ...
                            <div className="row">
                              <div className="col">
                                Informações que constarão da rotulagem das
                                embalagens primária e secundária, fechadas.
                              </div>
                            </div>
                            <div className="row mt-3">
                              <div className="col">
                          ...
                          <section id="embalagem_e_rotulagem">
                            ...
                            {ehNaoPerecivel && (
                              <div className="row mt-3">
                                ...
                                {valuesAny.produto_eh_liquido === "1" && (
                                  <div className="col-6 px-0">
                                    <div className="row">
                  ...
                  <ModalVoltar
                    ...
                    textoModalVoltar="Deseja realmente voltar? As alterações não salvas serão perdidas."
                  />
                </form>
              );
            }}
