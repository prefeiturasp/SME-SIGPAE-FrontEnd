...
describe("Teste Mensagem - Sem Unidades Educacionais", () => {
  beforeEach(async () => {
  ...
  it("Exibe mensagem de nenhum resultado no select de unidades educacionais", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Não existem resultados para os filtros selecionados"),
      ).toBeInTheDocument();
    });
  });
});
