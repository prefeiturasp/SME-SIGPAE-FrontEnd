...
describe("Test Relatório Reclamação Produto - Usuário Escola - Erro Carregar Terceirizadas", () => {
  beforeEach(async () => {
    mock
    ...
    mock.onGet("/terceirizadas/lista-nomes/").reply(400, {});
  ...
  it("Renderiza erro `Erro ao carregar terceirizadas. Tente novamente mais tarde.`", () => {
    expect(
      screen.getByText(
        "Erro ao carregar terceirizadas. Tente novamente mais tarde."
      )
    ).toBeInTheDocument();
  });
});
