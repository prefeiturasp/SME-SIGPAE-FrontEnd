...
describe("Test Relatório Reclamação Produto - Usuário Escola - Erro Carregar Fabricantes", () => {
  beforeEach(async () => {
    mock
    ...
    mock.onGet("/fabricantes/lista-nomes-unicos/").reply(400, {});
  ...
  it("Renderiza erro `Erro ao carregar Fabricantes. Tente novamente mais tarde.`", () => {
    expect(
      screen.getByText(
        "Erro ao carregar Fabricantes. Tente novamente mais tarde."
      )
    ).toBeInTheDocument();
  });
});
