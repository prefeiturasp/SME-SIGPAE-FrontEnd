...
describe("Test Relatório Reclamação Produto - Usuário Escola - Erro Carregar Marcas", () => {
  beforeEach(async () => {
    mock
    ...
    mock.onGet("/marcas/lista-nomes-unicos/").reply(400, {});
    mock
  ...
  it("Renderiza erro `Erro ao carregar Marcas. Tente novamente mais tarde.`", () => {
    expect(
      screen.getByText("Erro ao carregar Marcas. Tente novamente mais tarde.")
    ).toBeInTheDocument();
  });
});
