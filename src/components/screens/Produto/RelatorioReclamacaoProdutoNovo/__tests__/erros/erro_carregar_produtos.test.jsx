...
describe("Test Relatório Reclamação Produto - Usuário Escola - Erro Carregar Produtos", () => {
  beforeEach(async () => {
    mock
    ...
    mock.onGet("/produtos/lista-nomes-unicos/").reply(400, {});
  ...
  it("Renderiza erro `Erro ao carregar Produtos. Tente novamente mais tarde.`", () => {
    expect(
