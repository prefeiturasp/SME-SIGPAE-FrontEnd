...
import { mockLocationStateGrupoColaboradores } from "src/mocks/medicaoInicial/PeriodoLancamentoMedicaoInicial/RecreioNasFerias/CEUGESTAO/mockStateCEUGESTAOGrupoRecreio";
import { mockValoresMedicaoColaboradoresCEUGESTAO } from "src/mocks/medicaoInicial/PeriodoLancamentoMedicaoInicial/RecreioNasFerias/CEUGESTAO/valoresMedicaoCEUGESTAO";
...
import { mockSalvaLancamentoColaboradoresSemana1 } from "src/mocks/medicaoInicial/PeriodoLancamentoMedicaoInicial/RecreioNasFerias/CEUGESTAO/mockSalvaLancamentoCEUGESTAO.jsx";
import {
...
describe("Teste <PeriodoLancamentoMedicaoInicial> para o Grupo Colaboradores - CEU GESTÃO", () => {
  beforeEach(async () => {
    ...
    getValoresPeriodosLancamentos.mockResolvedValue({
      data: mockValoresMedicaoColaboradoresCEUGESTAO,
      status: 200,
    });
  ...
  it("ao clicar na tab `Semana 1`, exibe, nos dias 15 a 21, e verifica oa lançamentos", async () => {
    ...
    const VALORES_ESPERADOS = {
      15: { participantes: "10", frequencia: "6", lanche: "", lanche4h: "" },
      16: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
      17: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
      18: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
      19: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
  ...
  it("ao clicar na tab `Semana 2`, exibe, nos dias 22 a 28, e verifica oa lançamentos", async () => {
    ...
    const VALORES_ESPERADOS = {
      22: { participantes: "10", frequencia: "10", lanche: "", lanche4h: "" },
      23: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
      24: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
      25: { participantes: "", frequencia: "", lanche: "", lanche4h: "" },
      26: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
  ...
  it("ao clicar na tab `Semana 3`, exibe, nos dias 29 a 04/01/2026, e verifica oa lançamentos", async () => {
    ...
    const VALORES_ESPERADOS = {
      29: { participantes: "10", frequencia: "9", lanche: "", lanche4h: "" },
      30: { participantes: "10", frequencia: "", lanche: "", lanche4h: "" },
  ...
  it("ao clicar na tab `Semana 1`, preenche dia 15 e salva lançamento", async () => {
    ...
    expect(inputFrequencia).toHaveAttribute("value", "6");

    const inputLanche4h = screen.getByTestId(`lanche_4h__dia_15__categoria_1`);
    expect(inputLanche4h).toHaveAttribute("value", "6");
  ...
  it("ao clicar na tab `Semana 3`, preencher frequencia maior que participantes e exibe erro", async () => {
    ...
    const inputElementFrequenciaDia16 = screen.getByTestId(
      "frequencia__dia_29__categoria_1",
    );
    waitFor(() => {
      fireEvent.change(inputElementFrequenciaDia16, {
        target: { value: "20" },
  ...
  it("ao clicar na tab `Semana 3`, preencher lanche 4h maior que frequencia e exibe erro", async () => {
    ...
    fireEvent.click(semana3Element);
    const inputElementLanche4hDia15 = screen.getByTestId(
      "lanche_4h__dia_29__categoria_1",
    );
    waitFor(() => {
      fireEvent.change(inputElementLanche4hDia15, {
        target: { value: "20" },
  ...
  it("ao clicar na tab `Semana 3`, preenche dia 30 e salva lançamento", async () => {
    await awaitServices();
    const semana3Element = screen.getByText("Semana 3");
    fireEvent.click(semana3Element);
    ...
    const inputElementLanche4hDia15 = screen.getByTestId(
      "lanche_4h__dia_30__categoria_1",
    );
    fireEvent.change(inputElementLanche4hDia15, {
      target: { value: "10" },
    });
    ...
    const inputParticipantes = screen.getByTestId(
      `participantes__dia_30__categoria_1`,
    );
    expect(inputParticipantes).toHaveAttribute("value", "10");
    ...
    expect(inputFrequencia).toHaveAttribute("value", "10");

    const inputLanche4h = screen.getByTestId(`lanche_4h__dia_30__categoria_1`);
    expect(inputLanche4h).toHaveAttribute("value", "10");
