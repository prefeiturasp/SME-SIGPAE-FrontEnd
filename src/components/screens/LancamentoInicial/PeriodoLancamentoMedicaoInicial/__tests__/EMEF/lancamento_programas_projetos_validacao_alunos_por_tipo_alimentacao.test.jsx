...
import { mockInclusoesAutorizadasOutubro2025 } from "src/mocks/services/medicaoInicial/periodoLancamentoMedicao.service/EMEF/Outubro2025/ProgramasProjetos/inclusoesAutorizadas";
...
describe("Teste <PeriodoLancamentoMedicaoInicial> - Programas e Projetos - Usuário EMEF", () => {
  ...
  beforeEach(async () => {
    ...
    mock
      ...
      .reply(200, mockInclusoesAutorizadasOutubro2025);
    mock
