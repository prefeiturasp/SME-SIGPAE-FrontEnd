...
describe("Teste Refeições Simultâneas período NOITE - EMEF", () => {
  ...
  const mockVinculosTipoAlimentacaoPeriodoEscolarEMEFNOITE = {
  ...
  beforeEach(async () => {
    ...
    mock
      ...
      .reply(200, mockVinculosTipoAlimentacaoPeriodoEscolarEMEFNOITE);
    mock
...
describe("Teste Refeições Simultâneas período MANHA - EMEF", () => {
  const escolaUuid =
    mockMeusDadosEscolaEMEFPericles.vinculo_atual.instituicao.uuid;
  ...
  const mockVinculosTipoAlimentacaoPeriodoEscolarEMEFMANHA = {
    ...mockVinculosTipoAlimentacaoPeriodoEscolarEMEF,
    results: mockVinculosTipoAlimentacaoPeriodoEscolarEMEF.results.map(
      (item) => ({
        ...item,
  ...
  beforeEach(async () => {
    ...
    mock
      ...
      .reply(200, mockVinculosTipoAlimentacaoPeriodoEscolarEMEFMANHA);
    mock
      .onGet("/medicao-inicial/dias-sobremesa-doce/lista-dias/")
      .reply(200, []);
    mock.onGet("/tipos-alimentacao/").reply(200, mockGetTipoAlimentacao);
  ...
  describe("Testa o lançamntos do período MANHA", () => {
    describe("Testa a Alimentação", () => {
      ...
      it("Refeição e lanche 4h preenchidos sem observação - Deve aparecer adicionar no botão", async () => {
        const dia = "02";
        const botaoSalvar = screen
          .getByText("Salvar Lançamentos")
          .closest("button");
        ...
        expect(botaoObservacao).toHaveClass("green-button-outline-white");
        expect(botaoObservacao).not.toHaveTextContent("Visualizar");
        expect(botaoObservacao).toHaveTextContent("Adicionar");
        fireEvent.click(botaoObservacao);
