    ...
    if (payload.length > 0 && payload !== "selecione") {
      ...
      if (respProtocoloPadrao.status === HTTP_STATUS.OK) {
        ...
        const nomeEncontrado =
          protocolos.find((p) => p.uuid === payload)?.nome_protocolo || "";
        setNomeProtocolo(nomeEncontrado);
        form.change("nome_protocolo", nomeEncontrado);
      ...
      setNomeProtocolo("");
      form.change("nome_protocolo", undefined);
      form.change("substituicoes", undefined);
        ...
        <div className="col-12">
          <Field
            ...
            onChange={(e) => {
              ...
              setNomeProtocolo(val);
              form.change("nome_protocolo", val);
            }}
          />
        </div>
      </div>
