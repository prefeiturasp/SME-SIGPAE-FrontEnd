...
describe("Verifica comportamento da interface ao receber retorno de erro do endpoint de classificações", () => {
  beforeEach(async () => {
    mock.onGet("/lotes-simples/").reply(200, mockLotesSimples);
    mock.onGet("/classificacoes-dieta/").reply(400, {});
  ...
  it("Verifica renderização de mensagem de erro", async () => {
    await waitFor(() => {
      expect(
        screen.getByText("Erro ao carregar classificações de dieta.")
      ).toBeInTheDocument();
    });
  });
});
