...
import { mockGetClassificacaoDieta } from "mocks/services/dietaEspecial.service/mockGetClassificacoesDietas";
import { mockGetPeriodoEscolar } from "mocks/services/dietaEspecial.service/mockGetPeriodoEscolar";
...
import { mockGetUnidadeEducacional } from "mocks/services/dietaEspecial.service/mockGetUnidadeEducacional";
...
describe("Teste - Relatório Histórico de Dietas Especiais - Exportar Excel", () => {
  ...
  it("renderiza título `Relatório de Histórico de Dietas` e exporta excel", async () => {
