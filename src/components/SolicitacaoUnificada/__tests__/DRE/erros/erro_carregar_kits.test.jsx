...
describe("Formulário Solicitação Unificada - DRE - Erro ao carregar kits", () => {
  beforeEach(async () => {
    mock.onGet("/usuarios/meus-dados/").reply(200, mockMeusDadosCogestor);
    mock
      .onGet("/kit-lanches/")
      .reply(400, { detail: "Erro ao carregar kits lanche." });
  ...
  it("Deve renderizar erro `Erro ao carregar kits lanche. Tente novamente mais tarde.`", () => {
    expect(
      screen.getByText(
        "Erro ao carregar kits lanche. Tente novamente mais tarde.",
      ),
    ).toBeInTheDocument();
  });
});
