...
export const InclusaoDeAlimentacao = ({ ...props }) => {
  const [rascunhos, setRascunhos] = useState(undefined);
  ...
  const [idExterno, setIdExterno] = useState(undefined);
  const {
    meusDados,
    motivosSimples,
    motivosContinuos,
  ...
  const eventoEspecificoSelecionado = (values, index) => {
    return (
      values.inclusoes &&
      values.inclusoes[index] &&
      values.inclusoes[index].motivo &&
  ...
  const renderizaSelectSimples = (nomePeriodo) => {
    return (
  ...
  return _jsxs("div", {
    children: [
      _jsx("div", {
        className: "mt-3",
        children: _jsx(CardMatriculados, {
          meusDados: meusDados,
          numeroAlunos:
        ...
        children: ({
          ...
          _jsxs("form", {
            ...
            children: [
              ...
              _jsx("div", {
                className: "mt-2 page-title",
                children: uuid
                  ? `Solicitação # ${idExterno}`
                  : "Nova Solicitação",
              }),
              _jsx("div", {
                className: "card solicitation mt-2",
                children: _jsxs("div", {
                  className: "card-body",
                  children: [
                    _jsx("div", {
                            ...
                            "div",
                            {
                              children: [
                                ...
                                outroMotivoSelecionado(values, index) &&
                                  _jsx("div", {
                                    className: "mt-3",
                                    children: _jsx(OutroMotivo, { name: name }),
                                  }),
                                eventoEspecificoSelecionado(values, index) &&
                                  _jsx("div", {
                                    className: "mt-3",
                                    children: _jsx(EventoEspecifico, {
                                      name: name,
                                    }),
                                  }),
                                _jsx("hr", {}),
                    ...
                    motivoSimplesSelecionado(values) &&
                      _jsxs(_Fragment, {
                        children: [
                          _jsx("div", {
                            className: "mt-3",
                            children: _jsx(AdicionarDia, { push: push }),
                          }),
                          values.quantidades_periodo &&
                            _jsx(PeriodosInclusaoNormal, {
                              form: form,
                              values: values,
                              periodos:
                      ...
                      _jsxs(_Fragment, {
                        children: [
                          ...
                          values.quantidades_periodo &&
                            _jsx("div", {
                              className: "mt-5",
                              children: _jsx(RecorrenciaTabela, {
                                values: values,
                                periodos:
                                  ehMotivoInclusaoEspecifico(values) ||
                                  (carregandoRascunho && motivoEspecifico)
