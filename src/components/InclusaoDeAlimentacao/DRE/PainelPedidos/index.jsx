...
import { dreListarSolicitacoesDeInclusaoDeAlimentacao } from "services/inclusaoDeAlimentacao/dre.service";
...
export const PainelPedidos = ({ ...props }) => {
  ...
  const fetchSolicitacoes = async (
    ...
    const response = await dreListarSolicitacoesDeInclusaoDeAlimentacao(
      filtro,
      tipoSolicitacao,
      paramsFromPrevPage
    );
